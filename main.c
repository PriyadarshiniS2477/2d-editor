...
void addObject()
{
    ...
    if(type==1)
    {
        ...
        scanf("%d%d%d%d",&objects[objectCount].p[0],&objects[objectCount].p[1],&objects[objectCount].p[2],&objects[objectCount].p[3]);
    }
    ...
    scanf("%d%d%d",&objects[objectCount].p[0],&objects[objectCount].p[1],&objects[objectCount].p[2]);
}

else if(type==4){
    printf("Enter x1 y1 x2 y2 x3 y3: ");
    scanf("%d%d%d%d%d%d",&objects[objectCount].p[0],&objects[objectCount].p[1],&objects[objectCount].p[2],&objects[objectCount].p[3],&objects[objectCount].p[4],
